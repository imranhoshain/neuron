<?php get_header(); ?>
		...
		<section class="slider-area">
			...
			<!-- slide item one -->
			<div class="homepage-slider" style="background-image: url(<?php echo $slider_bg[0]; ?>)">
		...
		<section class="section-padding">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="block-img">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/homepageblock.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img class="hvr-buzz-out" src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/1.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/2.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/3.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/4.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/5.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/6.png" alt="" />
				...
				<div class="row">
					<div class="col-md-12">
						<div class="all-client-logo">
							<a href="#"><img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/cling-logo/1.jpg" alt="" /></a>
							<a href="#"><img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/cling-logo/2.jpg" alt="" /></a>
							<a href="#"><img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/cling-logo/3.jpg" alt="" /></a>
							<a href="#"><img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/cling-logo/4.jpg" alt="" /></a>
							<a href="#"><img src=" <?php echo get_stylesheet_directory_uri(); ?>/assets/img/cling-logo/5.jpg" alt="" /></a>
						</div>
					</div><!-- /.col-md-12 -->
				</div><!-- /.row -->
			</div><!-- /.container -->
